package com.smartroad.services.api.rest.auth;
...
import com.smartroad.services.core.dto.auth.SendOtpRequestDTO;
...
import com.smartroad.services.core.service.auth.AuthService;
import com.smartroad.services.core.service.auth.OtpService;
    ...
    public ResponseEntity<Object> sendOtp(@RequestBody @Valid SendOtpRequestDTO request,
        ...
        if (request.getEmail() != null && !request.getEmail().isBlank()) {
            ...
            throw new SmartRoadException(
                    com.smartroad.services.common.exception.ApplicationLayer.SERVICE_LAYER,
                    com.smartroad.services.common.exception.ErrorCodeMapping.SERVICE_INVALID_INPUT,
